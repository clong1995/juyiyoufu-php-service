...
CREATE TABLE `company`  (
  ...
  CONSTRAINT `company_employee_id` FOREIGN KEY (`employee_id`) REFERENCES `user` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
-- Records of company
-- ----------------------------
INSERT INTO `company` VALUES (1, '青岛巨蚁优服', '5514eddb820475931902c79e33830f65', 110000, 110100, 110101, '', '1', NULL, 1);
INSERT INTO `company` VALUES (31, '222', '3aba1d21906c1739162fe1d5345ce6e0', 110000, 110100, 110101, '222', '22', 'e352b74dc69801bef0295e9e23585d8d', 51);
INSERT INTO `company` VALUES (33, '333', 'e352b74dc69801bef0295e9e23585d8d', 130000, 130100, 130102, '333', '333', 'e352b74dc69801bef0295e9e23585d8d', 53);
INSERT INTO `company` VALUES (35, 'www', NULL, 130000, 130200, 130205, 'dfdsfsdf山东省', 'www', 'd236d0fcef242e64ea77afc1987a5b5b', 55);
...
-- ----------------------------
-- Table structure for customer_company_relation
-- ----------------------------
DROP TABLE IF EXISTS `customer_company_relation`;
CREATE TABLE `customer_company_relation`  (
  ...
  CONSTRAINT `user__company_id` FOREIGN KEY (`user_id`) REFERENCES `customer` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Compact;
...
CREATE TABLE `customer_info`  (
  ...
  CONSTRAINT `id` FOREIGN KEY (`id`) REFERENCES `customer` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
...
-- Records of file
-- ----------------------------
INSERT INTO `file` VALUES ('0d1edc9526f54e7da329db3cc31199b2', 'png', 'file', '屏幕截图 2018-08-06 01.36.24.png');
INSERT INTO `file` VALUES ('1448b3cc0f21b3c9ed035f4a20dc89fd', 'png', 'file', '屏幕截图 2018-08-08 01.13.19.png');
INSERT INTO `file` VALUES ('162d2e11fafff16e061d351738005283', 'jpeg', 'file', 'webwxgetmsgimg.jpeg');
INSERT INTO `file` VALUES ('308e6c9893e21b5bbf83e661f2f69d3d', 'png', 'file', '屏幕截图 2018-08-07 23.52.50.png');
INSERT INTO `file` VALUES ('3aba1d21906c1739162fe1d5345ce6e0', 'png', 'file', '屏幕截图 2018-07-03 02.15.22.png');
INSERT INTO `file` VALUES ('3c20dff9cbf661567e5e83f4370d6cd4', 'jpeg', 'file', '1664555536.jpg');
INSERT INTO `file` VALUES ('494f9239804dac22d16ad5f9bc12cef6', 'jpeg', 'file', 'ec4b3e8f537da3d80bf3d7fc15c9aff8.jpg');
INSERT INTO `file` VALUES ('5514eddb820475931902c79e33830f65', 'jpeg', 'file', 'timg (1).jpeg');
INSERT INTO `file` VALUES ('70af42cec2282dc75e9b40c72e3220ff', 'png', 'file', '屏幕截图 2018-08-06 01.59.31.png');
INSERT INTO `file` VALUES ('765c158591d9daa6babfbfc3fa8df464', 'png', 'file', '屏幕截图 2018-08-07 23.43.02.png');
INSERT INTO `file` VALUES ('7a9c12ce0ea3fa9ac4c53890f61e0438', 'jpeg', 'file', '144.jpeg');
INSERT INTO `file` VALUES ('7ba0bdeaadda9ab48c903ab72f6904ce', 'jpeg', 'file', 'webwxgetmsgimg (3).jpeg');
INSERT INTO `file` VALUES ('7e3c97feec6d78f7d84ddd3d82526dbf', 'jpeg', 'file', '7febbd56dc73521cf52bc9b7a854426f.jpg');
INSERT INTO `file` VALUES ('94206b91309b930370281f9975213858', 'jpeg', 'file', 'webwxgetmsgimg (1).jpeg');
INSERT INTO `file` VALUES ('b7714b3b387e1132ab98f659b6a69085', 'png', 'file', '屏幕截图 2018-08-07 00.03.02.png');
INSERT INTO `file` VALUES ('c5315bf13cd2c39de4af99fbf558c2dd', 'jpeg', 'file', 'bcdbb049e99cf8f075faa50b74e8d353.jpg');
INSERT INTO `file` VALUES ('d236d0fcef242e64ea77afc1987a5b5b', 'jpeg', 'file', '108.jpeg');
INSERT INTO `file` VALUES ('e352b74dc69801bef0295e9e23585d8d', 'png', 'file', '屏幕截图 2018-07-03 02.14.32.png');
...
CREATE TABLE `menu`  (
  `menu_id` tinyint(2) UNSIGNED NOT NULL AUTO_INCREMENT,
  `parent_id` tinyint(2) UNSIGNED NOT NULL COMMENT '上级菜单',
  `name` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '名称',
  `in_order` tinyint(2) NOT NULL COMMENT '排序',
  `icon` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '图标',
  `menu_type_id` tinyint(2) UNSIGNED NOT NULL COMMENT '菜单类型',
  `info` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '菜单描述',
  `privilege_id` tinyint(2) UNSIGNED NOT NULL COMMENT '绑定的权限',
  PRIMARY KEY (`menu_id`) USING BTREE,
  INDEX `menu_type_id`(`menu_type_id`) USING BTREE,
  INDEX `menu_privilege_id`(`privilege_id`) USING BTREE,
  CONSTRAINT `menu_privilege_id` FOREIGN KEY (`privilege_id`) REFERENCES `privilege` (`privilege_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `menu_type_id` FOREIGN KEY (`menu_type_id`) REFERENCES `type` (`type_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB AUTO_INCREMENT = 6 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Records of menu
-- ----------------------------
INSERT INTO `menu` VALUES (1, 0, '权限管理', 0, '&#xe61d;', 1, '权限管理', 1);
INSERT INTO `menu` VALUES (2, 0, '角色管理', 0, '&#xe61d;', 1, '角色管理', 28);
INSERT INTO `menu` VALUES (3, 0, '公司管理', 0, '&#xe61d;', 1, '公司管理', 3);
INSERT INTO `menu` VALUES (5, 0, '菜单管理', 0, '&#xe61d;', 1, '菜单管理', 4);
...
CREATE TABLE `privilege`  (
  ...
  `path` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '资源地址',
  ...
  `privilege_type` tinyint(2) UNSIGNED NOT NULL COMMENT '权限类型',
  `t` timestamp(0) NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '添加时间',
  INDEX `privilege_info_id`(`privilege_id`) USING BTREE,
  INDEX `privilege_type`(`privilege_type`) USING BTREE,
  CONSTRAINT `privilege_type` FOREIGN KEY (`privilege_type`) REFERENCES `type` (`type_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Records of privilege
-- ----------------------------
INSERT INTO `privilege` VALUES (2, 'index', '首页', 'PC端的首页', 2, '2018-07-30 02:30:12');
INSERT INTO `privilege` VALUES (3, 'company/list', '公司列表', '所有的公司', 2, '2018-07-30 02:30:08');
INSERT INTO `privilege` VALUES (4, 'menu/list', '菜单管理', '首页菜单列表', 2, '2018-07-30 02:30:04');
INSERT INTO `privilege` VALUES (26, 'api/power/delete', '删除权限', '删除权限的接口', 8, '2018-07-15 02:09:28');
INSERT INTO `privilege` VALUES (28, 'role/list', '角色管理', '角色管理', 2, '2018-07-15 19:21:32');
INSERT INTO `privilege` VALUES (29, 'role/add', '添加角色', '添加角色', 2, '2018-07-15 21:42:02');
INSERT INTO `privilege` VALUES (30, 'role/edit', '编辑角色', '编辑角色', 2, '2018-07-15 21:43:55');
INSERT INTO `privilege` VALUES (31, 'api/role/relPrivilege', '角色关联权限', '角色关联权限', 8, '2018-07-16 02:23:09');
INSERT INTO `privilege` VALUES (32, 'api/role/delRelPrivilege', '删除权限角色关联', '删除权限和角色的关联关系', 8, '2018-07-16 02:37:43');
INSERT INTO `privilege` VALUES (34, 'employee/list', '员工管理', '员工管理', 2, '2018-07-16 03:06:00');
INSERT INTO `privilege` VALUES (1, 'power/list', '权限列表', '权限列表', 2, '2018-07-16 22:27:55');
INSERT INTO `privilege` VALUES (35, 'power/edit', '编辑权限', '编辑权限', 2, '2018-07-16 22:31:10');
INSERT INTO `privilege` VALUES (36, 'api/power/update', '修改权限', '编辑修改权限发送到后端', 8, '2018-07-16 23:52:30');
INSERT INTO `privilege` VALUES (37, 'company/add', '增加公司', '增加平台授权的公司', 2, '2018-07-17 21:18:51');
INSERT INTO `privilege` VALUES (38, 'api/regional/city', '获取地市', '根据省份获取地市列表', 8, '2018-07-17 22:44:37');
INSERT INTO `privilege` VALUES (39, 'api/regional/area', '获取区县', '根据地市获取区县', 8, '2018-07-17 22:59:49');
INSERT INTO `privilege` VALUES (40, 'api/company/add', '增加公司', '增加公司', 8, '2018-07-18 00:06:59');
INSERT INTO `privilege` VALUES (41, 'api/upload/file', '文件上传', '文件上传', 8, '2018-07-19 00:18:54');
INSERT INTO `privilege` VALUES (44, 'api/company/delete', '删除公司', '根据id删除公司', 8, '2018-07-21 21:03:37');
INSERT INTO `privilege` VALUES (45, 'company/edit', '修改公司', '修改公司信息', 2, '2018-07-21 22:11:09');
INSERT INTO `privilege` VALUES (46, 'api/company/update', '修改公司', '修改公司', 8, '2018-07-22 01:01:55');
INSERT INTO `privilege` VALUES (47, 'api/power/getPage', '权限翻页', '权限列表的翻页', 8, '2018-07-30 01:40:39');
INSERT INTO `privilege` VALUES (7, 'power/add', '添加权限', '添加权限', 2, '2018-07-30 02:29:21');
INSERT INTO `privilege` VALUES (9, 'api/power/add', '添加权限', '添加权限', 8, '2018-07-30 02:29:47');
INSERT INTO `privilege` VALUES (5, 'consumer/list', '客户列表', '客户列表', 2, '2018-07-30 02:31:18');
INSERT INTO `privilege` VALUES (6, 'nurse/list', '护工列表', '护工列表', 2, '2018-07-30 02:31:45');
INSERT INTO `privilege` VALUES (8, 'nurse/add', '添加护工', '添加护工', 2, '2018-07-30 02:32:02');
INSERT INTO `privilege` VALUES (49, 'api/role/update', '修改角色', '修改角色', 8, '2018-07-31 00:48:16');
INSERT INTO `privilege` VALUES (50, 'api/role/delPrivilege', '解除角色绑定权限', '解除角色绑定权限', 8, '2018-07-31 01:39:55');
INSERT INTO `privilege` VALUES (51, 'api/role/add', '添加角色', '添加角色', 8, '2018-08-01 01:17:24');
INSERT INTO `privilege` VALUES (52, 'api/role/delete', '删除角色', '根据删除角色', 8, '2018-08-01 01:43:53');
INSERT INTO `privilege` VALUES (60, 'api/company/getPage', '公司翻页', '公司列表页面的翻页', 8, '2018-08-05 00:20:12');
INSERT INTO `privilege` VALUES (61, 'api/role/getPage', '角色翻页', '角色列表的翻页', 8, '2018-08-05 00:47:27');
INSERT INTO `privilege` VALUES (63, 'api/company/getPage', '公司翻页', '公司翻页', 8, '2018-08-05 16:00:15');
INSERT INTO `privilege` VALUES (64, 'api/menu/getPage', '首页菜单翻页', '首页菜单翻页', 8, '2018-08-10 01:35:02');
INSERT INTO `privilege` VALUES (65, 'menu/add', '增加菜单', '增加首页菜单', 2, '2018-08-11 00:28:57');
INSERT INTO `privilege` VALUES (0, 'fghjkl', 'asdfghjk', '12345678', 3, '2018-08-19 13:32:57');
...
INSERT INTO `role` VALUES (4, 'sdfghj');
...
-- ----------------------------
INSERT INTO `role_info` VALUES ('超级管理员', 1, '系统的超级管理员');
INSERT INTO `role_info` VALUES ('普通用户', 2, '普通用户hhh');
INSERT INTO `role_info` VALUES ('日发给他回家看', 4, '儿推开');
...
INSERT INTO `role_privilege_relation` VALUES (1, 3);
INSERT INTO `role_privilege_relation` VALUES (1, 4);
INSERT INTO `role_privilege_relation` VALUES (1, 5);
INSERT INTO `role_privilege_relation` VALUES (1, 6);
INSERT INTO `role_privilege_relation` VALUES (1, 7);
INSERT INTO `role_privilege_relation` VALUES (1, 9);
INSERT INTO `role_privilege_relation` VALUES (1, 26);
INSERT INTO `role_privilege_relation` VALUES (1, 28);
INSERT INTO `role_privilege_relation` VALUES (1, 29);
INSERT INTO `role_privilege_relation` VALUES (1, 30);
INSERT INTO `role_privilege_relation` VALUES (1, 31);
INSERT INTO `role_privilege_relation` VALUES (1, 32);
INSERT INTO `role_privilege_relation` VALUES (1, 35);
INSERT INTO `role_privilege_relation` VALUES (1, 36);
INSERT INTO `role_privilege_relation` VALUES (1, 37);
INSERT INTO `role_privilege_relation` VALUES (1, 38);
INSERT INTO `role_privilege_relation` VALUES (1, 39);
INSERT INTO `role_privilege_relation` VALUES (1, 40);
INSERT INTO `role_privilege_relation` VALUES (1, 41);
INSERT INTO `role_privilege_relation` VALUES (1, 44);
INSERT INTO `role_privilege_relation` VALUES (1, 45);
INSERT INTO `role_privilege_relation` VALUES (1, 46);
INSERT INTO `role_privilege_relation` VALUES (1, 47);
INSERT INTO `role_privilege_relation` VALUES (1, 49);
INSERT INTO `role_privilege_relation` VALUES (1, 50);
INSERT INTO `role_privilege_relation` VALUES (1, 51);
INSERT INTO `role_privilege_relation` VALUES (1, 52);
INSERT INTO `role_privilege_relation` VALUES (1, 61);
INSERT INTO `role_privilege_relation` VALUES (1, 63);
INSERT INTO `role_privilege_relation` VALUES (1, 64);
INSERT INTO `role_privilege_relation` VALUES (1, 65);
INSERT INTO `role_privilege_relation` VALUES (2, 2);
INSERT INTO `role_privilege_relation` VALUES (2, 5);
INSERT INTO `role_privilege_relation` VALUES (2, 6);
INSERT INTO `role_privilege_relation` VALUES (2, 8);
INSERT INTO `role_privilege_relation` VALUES (2, 34);
INSERT INTO `role_privilege_relation` VALUES (2, 41);
INSERT INTO `role_privilege_relation` VALUES (4, 8);
...
CREATE TABLE `type`  (
  ...
  `name` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '值',
  `info` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '名称',
  `category` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '类型的分类',
...
-- Records of type
-- ----------------------------
INSERT INTO `type` VALUES (0, '', '根菜单', 'menu');
INSERT INTO `type` VALUES (1, '', '首页菜单', 'menu');
INSERT INTO `type` VALUES (2, '客户端', '客户端的域', 'domain');
INSERT INTO `type` VALUES (3, '网页端', '网页端的域', 'domain');
INSERT INTO `type` VALUES (4, '移动端', '移动端的域', 'domain');
INSERT INTO `type` VALUES (5, '', 'pc端顶部操作菜单', 'menu');
INSERT INTO `type` VALUES (6, '男', '男', 'sex');
INSERT INTO `type` VALUES (7, '女', '女', 'sex');
INSERT INTO `type` VALUES (8, '请求', 'api', 'domain');
...
CREATE TABLE `user`  (
  `user_id` smallint(5) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '公司id',
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES (1, 'admin', 'E10ADC3949BA59ABBE56E057F20F883E', NULL);
INSERT INTO `user` VALUES (11, '15166077180', 'E10ADC3949BA59ABBE56E057F20F883E', NULL);
INSERT INTO `user` VALUES (51, '15166077181', 'E10ADC3949BA59ABBE56E057F20F883E', NULL);
INSERT INTO `user` VALUES (52, '111', 'E10ADC3949BA59ABBE56E057F20F883E', NULL);
INSERT INTO `user` VALUES (53, '333', 'E10ADC3949BA59ABBE56E057F20F883E', NULL);
INSERT INTO `user` VALUES (54, '23456', 'E10ADC3949BA59ABBE56E057F20F883E', NULL);
INSERT INTO `user` VALUES (55, '3453', 'E10ADC3949BA59ABBE56E057F20F883E', NULL);
INSERT INTO `user` VALUES (56, '222', 'E10ADC3949BA59ABBE56E057F20F883E', NULL);
INSERT INTO `user` VALUES (57, '11', 'E10ADC3949BA59ABBE56E057F20F883E', NULL);
...
CREATE TABLE `user_info`  (
  ...
  PRIMARY KEY (`user_id`) USING BTREE,
  INDEX `user_area_id`(`area_id`) USING BTREE,
  INDEX `user_city_id`(`city_id`) USING BTREE,
  INDEX `user_company_id`(`company_id`) USING BTREE,
  INDEX `user_file_id`(`head_image_id`) USING BTREE,
  INDEX `user_province_id`(`province_id`) USING BTREE,
  INDEX `user_role_id`(`role_id`) USING BTREE,
  CONSTRAINT `user_area_id` FOREIGN KEY (`area_id`) REFERENCES `areas` (`areaid`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `user_city_id` FOREIGN KEY (`city_id`) REFERENCES `cities` (`cityid`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `user_company_id` FOREIGN KEY (`company_id`) REFERENCES `company` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `user_file_id` FOREIGN KEY (`head_image_id`) REFERENCES `file` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `user_id` FOREIGN KEY (`user_id`) REFERENCES `user` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `user_province_id` FOREIGN KEY (`province_id`) REFERENCES `provinces` (`provinceid`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `user_role_id` FOREIGN KEY (`role_id`) REFERENCES `role` (`role_id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Records of user_info
-- ----------------------------
INSERT INTO `user_info` VALUES (1, 'admin', 110000, 110100, 110101, '0d1edc9526f54e7da329db3cc31199b2', 1, 1);
INSERT INTO `user_info` VALUES (11, '测试', 110000, 120100, 110104, '162d2e11fafff16e061d351738005283', 31, 2);
